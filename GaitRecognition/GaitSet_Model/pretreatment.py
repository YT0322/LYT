...
parser.add_argument('--input_path', default='./GaitDatasetB-silh', type=str,
                    help='Root path of raw dataset.')
parser.add_argument('--output_path', default='./GaitDatasetB_Cutted', type=str,
